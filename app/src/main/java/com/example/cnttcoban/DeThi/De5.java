...
public class De5 {
    ...
    private ArrayList<Question> de5;
    ...
    public De5(final Activity activity, Button a, Button b, Button c, Button d, TextView tvQuesContainer) {
        De5.a = a;
        De5.b = b;
        De5.c = c;
        De5.d = d;
        this.tvQuesContainer = tvQuesContainer;
        de5 = TaoCauHoi.createQuestions5(activity);
    }
    ...
    public void playGame() {
        ...
        askQuestion(myFirstQuestion, new De5.reply() {
            @Override
            public void answer() {
            }
    ...
    private void askQuestion(int questionOrder, final De5.reply reply) {
        index = questionOrder;
        question = de5.get(index);
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (index < (getQuestionAmount() - 1)) {
                                        index++;
                                        askQuestion(index, new De5.reply() {
                                            @Override
                                            public void answer() {
                                            }
