...
public class De4 {
    ...
    private ArrayList<Question> de4;
    ...
    public De4(final Activity activity, Button a, Button b, Button c, Button d, TextView tvQuesContainer) {
        De4.a = a;
        De4.b = b;
        De4.c = c;
        De4.d = d;
        this.tvQuesContainer = tvQuesContainer;
        de4 = TaoCauHoi.createQuestions4(activity);
    }
    ...
    public void playGame() {
        ...
        askQuestion(myFirstQuestion, new De4.reply() {
            @Override
            public void answer() {
            }
    ...
    private void askQuestion(int questionOrder, final De4.reply reply) {
        index = questionOrder;
        question = de4.get(index);
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (index < (getQuestionAmount() - 1)) {
                                        index++;
                                        askQuestion(index, new De4.reply() {
                                            @Override
                                            public void answer() {
                                            }
