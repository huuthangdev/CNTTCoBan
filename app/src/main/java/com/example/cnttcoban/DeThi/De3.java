...
public class De3 {
    ...
    private ArrayList<Question> de3;
    ...
    public De3(final Activity activity, Button a, Button b, Button c, Button d, TextView tvQuesContainer) {
        De3.a = a;
        De3.b = b;
        De3.c = c;
        De3.d = d;
        this.tvQuesContainer = tvQuesContainer;
        de3 = TaoCauHoi.createQuestions3(activity);
    }
    ...
    public void playGame() {
        ...
        askQuestion(myFirstQuestion, new De3.reply() {
            @Override
            public void answer() {
            }
    ...
    private void askQuestion(int questionOrder, final De3.reply reply) {
        index = questionOrder;
        question = de3.get(index);
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (index < (getQuestionAmount() - 1)) {
                                        index++;
                                        askQuestion(index, new De3.reply() {
                                            @Override
                                            public void answer() {
                                            }
